...
source("R/02-create-empty-country-months.R")
source("R/03-clean-idea-data.R")
source("R/04-create-variables-to-merge-ccode-idea3.R")
source("R/05-fill-country-months-with-counts.R")
source("R/06-add-model-estimates.R")
source("R/07-aggregate-latent-measures.R")
#source("R/08-plot-eta.R")
source("R/09-plot-cors.R")
